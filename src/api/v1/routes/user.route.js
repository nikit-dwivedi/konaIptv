...
const { register, emailVerification, login, sendOtp, otpVerification, changeCurrentPassword, markUserSubscribed, getAllUsers, changeBlockStatus, getBloackedUsers } = require('../controller/user.controller.js');
